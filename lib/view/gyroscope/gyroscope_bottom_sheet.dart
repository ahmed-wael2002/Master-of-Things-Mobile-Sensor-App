...
class GyroscopeBottomSheet extends StatefulWidget {
  final GyroscopeSensor sensor;

  const GyroscopeBottomSheet({super.key, required this.sensor});

  @override
  State<GyroscopeBottomSheet> createState() => _GyroscopeBottomSheetState();
}

class _GyroscopeBottomSheetState extends State<GyroscopeBottomSheet> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Gyroscope Sensor ID: ${widget.sensor.sensorId}',
